    ...
    for (const then of rule.then) {
        ...
        for (const target of targets) {
            ...
            if ('then' in targetResults) {
                context.promises.push(targetResults.then(results => results === void 0
                    ? void 0
                    : void processTargetResults(context, results, rule, path)));
            }
            else {
                processTargetResults(context, targetResults, rule, path);
            }
        }
    }
};
exports.lintNode = lintNode;
function processTargetResults(context, results, rule, targetPath) {
    var _a, _b, _c, _d, _e;
