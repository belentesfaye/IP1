...
const defaultComputeResultFingerprint = (rule, hash) => {
...
exports.defaultComputeResultFingerprint = defaultComputeResultFingerprint;
const prepareResults = (results, computeFingerprint) => {
...
const deduplicateResults = (results) => {
    return (0, lodash_1.uniqBy)([...results], 'fingerprint');
};
