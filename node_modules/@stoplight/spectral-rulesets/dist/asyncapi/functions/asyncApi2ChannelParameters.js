...
exports.default = (0, spectral_core_1.createRulesetFunction)({
    ...
    if (parameters.length === 0)
        return;
    const missingParameters = (0, getMissingProps_1.getMissingProps)(parameters, targetVal.parameters);
    ...
    const redundantParameters = (0, getRedundantProps_1.getRedundantProps)(parameters, targetVal.parameters);
...
//# sourceMappingURL=asyncApi2ChannelParameters.js.map