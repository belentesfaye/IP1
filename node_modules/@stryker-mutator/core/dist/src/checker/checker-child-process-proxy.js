...
export class CheckerChildProcessProxy {
    constructor(options, fileDescriptions, pluginModulePaths, loggingContext) {
        this.childProcess = ChildProcessProxy.create(new URL('./checker-worker.js', import.meta.url).toString(), loggingContext, options, fileDescriptions, pluginModulePaths, process.cwd(), CheckerWorker, options.checkerNodeArgs);
    }
    async dispose() {
