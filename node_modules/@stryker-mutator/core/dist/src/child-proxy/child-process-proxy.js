...
export class ChildProcessProxy {
    constructor(modulePath, namedExport, loggingContext, options, fileDescriptions, pluginModulePaths, workingDirectory, execArgv) {
        this.workerTasks = [];
     ...
     */
    static create(modulePath, loggingContext, options, fileDescriptions, pluginModulePaths, workingDirectory, injectableClass, execArgv) {
        return new ChildProcessProxy(modulePath, injectableClass.name, loggingContext, options, fileDescriptions, pluginModulePaths, workingDirectory, execArgv);
    }
    send(message) {
