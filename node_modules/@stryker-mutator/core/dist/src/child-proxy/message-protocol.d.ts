...
export declare type WorkerMessage = CallMessage | DisposeMessage | InitMessage;
export declare type ParentMessage = InitRejectionResult | RejectionResult | WorkResult | {
