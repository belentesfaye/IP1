...
export declare class ChildProcessTestRunnerProxy implements TestRunner {
    ...
    constructor(options: StrykerOptions, fileDescriptions: FileDescriptions, sandboxWorkingDirectory: string, loggingContext: LoggingClientContext, pluginModulePaths: readonly string[], log: Logger);
