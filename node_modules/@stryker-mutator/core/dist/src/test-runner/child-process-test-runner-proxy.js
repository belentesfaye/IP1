...
export class ChildProcessTestRunnerProxy {
    constructor(options, fileDescriptions, sandboxWorkingDirectory, loggingContext, pluginModulePaths, log) {
        this.log = log;
        this.worker = ChildProcessProxy.create(new URL('./child-process-test-runner-worker.js', import.meta.url).toString(), loggingContext, options, fileDescriptions, pluginModulePaths, sandboxWorkingDirectory, ChildProcessTestRunnerWorker, options.testRunnerNodeArgs);
    }
    capabilities() {
