...
export declare type Ast = HtmlAst | JSAst | TSAst | TsxAst;
export declare type ScriptFormat = AstFormat.JS | AstFormat.TS | AstFormat.Tsx;
export declare type ScriptAst = JSAst | TSAst | TsxAst;
