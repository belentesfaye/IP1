...
export class JestTestRunner {
    constructor(log, options, jestTestAdapter, configLoader, globalNamespace) {
        this.log = log;
    ...
    configForMutantRun(fileNameUnderTest, hitLimit) {
...
JestTestRunner.inject = tokens(commonTokens.logger, commonTokens.options, pluginTokens.jestTestAdapter, pluginTokens.configLoader, pluginTokens.globalNamespace);
