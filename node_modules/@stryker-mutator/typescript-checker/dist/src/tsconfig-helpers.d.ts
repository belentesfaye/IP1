export declare function guardTSVersion(): void;
/**
 ...
 */
export declare function determineBuildModeEnabled(tsconfigFileName: string): boolean;
/**
 ...
 */
export declare function overrideOptions(parsedConfig: {
    config?: any;
 ...
 */
export declare function retrieveReferencedProjects(parsedConfig: {
    config?: any;
 ...
 */
export declare function toPosixFileName(fileName: string): string;
//# sourceMappingURL=tsconfig-helpers.d.ts.map