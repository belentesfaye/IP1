...
let MutationTestReportMutantViewComponent = class MutationTestReportMutantViewComponent extends LitElement {
    constructor() {
        super(...arguments);
...
MutationTestReportMutantViewComponent.styles = [bootstrap, unsafeCSS(style)];
__decorate([
    property()
